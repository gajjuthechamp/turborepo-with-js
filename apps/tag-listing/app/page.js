  ...
  return (
    <>
      <main className="text-center mt-5">
        <Heading tag='h1' content='Tag listing page - Heading Component' />
        ...
        <br /> <br />
        <Button bleed="auto" className="capitalize" size="sm" type="secondary" title="This is a Tag listing button" />
      </main>
    </>
  );
}
